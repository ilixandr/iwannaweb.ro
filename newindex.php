          ...
          <ul class="nav navbar-nav navbar-nav-fit">
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li>
                  <a href=<?php echo "newindex.php?lang=" . substr($txt["lang_flag_1"], 0, 2)?>><img class="img-flag" src=<?php echo "\"images/" . $txt["lang_flag_1"] . ".svg\""?>><?php echo $txt["lang_alt_1"]?></a>
                </li>
                <li>
                  <a href=<?php echo "newindex.php?lang=" . substr($txt["lang_flag_2"], 0, 2)?>><img class="img-flag" src=<?php echo "\"images/" . $txt["lang_flag_2"] . ".svg\""?>><?php echo $txt["lang_alt_2"]?></a>
                </li> 
              </ul>
            </li> 
          </ul>
