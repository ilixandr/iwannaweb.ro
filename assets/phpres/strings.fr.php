...
$txt["portfolio_p0_quote"] = " La liberté sans structure est son propre esclavage ";
$txt["portfolio_p0_author"] = " (David Brooks)";
$txt["portfolio_p1"] = "Nous commencerons par comprendre l’objectif de votre produit et ce que vous essayez d’atteindre d'un point de vue de l’utilisateur final. Nous devons déterminer qui sont les utilisateurs finaux et les caractéristiques pertinentes pour l'efficacité du produit. Une autre information importante est la concurrence et son produit.";
$txt["portfolio_p2"] = "Idéalement, notre client devrait fournir la plupart des informations ci-dessus. Bien entendu, nous vous contacterons (par mail ou par téléphone) si nous avons besoin de précisions ou si vous croyez qu'il fallait qu'on vous aide à déterminer les spécifications ci-dessus. Le point central de notre approche est l’utilisateur final. En conséquence, nous devons comprendre cet utilisateur final, ses exigences et son comportement, ainsi que le positionnement de la concurrence, pour construire un produit superieur.";
